...
const blogPosts = [
    {
        ...
        excerpt: "Dicas práticas para se destacar em entrevistas técnicas e conquistar a vaga de estágio dos seus sonhos.",
        content:
    ...
    },
    {
        ...
        excerpt: "Estratégias para gerenciar seu tempo e manter um bom desempenho tanto no estágio quanto nos estudos.",
        content:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eu aliquam nisl nisl sit amet nisl. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eu aliquam nisl nisl sit amet nisl.",
        author: "Pedro Alves",
    ...
    },
    {
        ...
        excerpt: "Descubra quais são as habilidades técnicas e comportamentais mais valorizadas pelos recrutadores.",
        content:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eu aliquam nisl nisl sit amet nisl. Sed euismod, nisl vel ultricies lacinia, nisl nisl aliquam nisl, eu aliquam nisl nisl sit amet nisl.",
    ...
    return (
        <div className="bg-white rounded-xl shadow-soft overflow-hidden hover:shadow-medium transition-shadow">
            ...
            <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-dark mb-2 line-clamp-2">{post.title}</h3>
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <div>
                            <p className="text-sm font-medium text-gray-dark">{post.author}</p>
        ...
        <div className="bg-white rounded-xl shadow-soft overflow-hidden mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-6 md:p-8 flex flex-col justify-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-dark mb-4">{post.title}</h2>
...
export default function Blog() {
    ...
    const filteredPosts = categoryFilter ? blogPosts.filter((post) => post.category === categoryFilter) : blogPosts
            ...
            <section className="bg-primary text-white py-12">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">Blog DevStage</h1>
                        <p className="text-lg mb-6">
                            Dicas, tutoriais e insights para impulsionar sua carreira em desenvolvimento de software
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 flex flex-wrap gap-2">
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-sm font-medium ${categoryFilter === "" ? "bg-primary text-white" : "bg-white text-gray-dark hover:bg-gray-100"
                                }`}
                        >
                            Todos
                        </button>
                        {categories.map((category) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-sm font-medium ${categoryFilter === category ? "bg-primary text-white" : "bg-white text-gray-dark hover:bg-gray-100"
                                    }`}
                            >
                                {category}
                            </button>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <p className="text-white/80 mb-8">
                            Receba as últimas novidades, dicas e oportunidades de estágio diretamente no seu e-mail.
                        </p>
