    ...
    return (
        <div className="bg-white rounded-lg shadow-soft overflow-hidden hover:shadow-medium transition-shadow">
            ...
            <div className="p-4">
                ...
                <h3 className="text-lg font-bold text-gray-dark mt-2 mb-1 line-clamp-2">{post.title}</h3>
                <p className="text-sm text-gray-dark mb-2 line-clamp-2">{post.excerpt}</p>
                <Link
                    href={`/blog/${post.id}`}
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            if (currentPost) {
                ...
                // Encontrar posts relacionados (mesma categoria ou tags em comum)
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="flex items-center mb-2">
                            <span className="text-sm font-medium bg-white/20 px-3 py-1 rounded-full">{post.category}</span>
